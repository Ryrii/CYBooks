...
public class SearchBookController {
    ...
    private void handleSearchButton() {
        ...
        bookFound = false;
        try {
            if (!bookService.checkBookExists(isbnSearch)) {
            ...
            isbn = null;
            System.out.println("Pas de livre avec l'ISBN "+isbnSearch+" trouvé !");
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information Dialog");
            alert.setHeaderText(null);
            alert.setContentText("Pas de livre avec l'ISBN "+isbnSearch+" trouvé !");
            alert.showAndWait();
        }
