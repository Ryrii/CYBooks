 ...
 */
public class UserCurrentLoanController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        returnDateColumn.setCellValueFactory(new PropertyValueFactory<>("dueDate"));
    ...
    public void initData(User user) {
        List<Loan> userLoanHistory = loanService.getUserCurrentLoans(user.getId());
